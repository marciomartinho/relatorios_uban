"""
Relatório: Receita de Amortização de Empréstimos Líquida Realizada
Analisa receitas da origem 23 com desdobramentos por alínea
REGRAS:
- ORIGEM = 23 (receitas de amortização de empréstimos)
...
def gerar_relatorio_receitas_amortizacao_emprestimo(df_completo, estrutura_hierarquica=None, noug_selecionada=None):
    """
    Gera relatório de receitas de amortização de empréstimos líquidas com comparativo 2024 vs 2025
    
    REGRAS DE NEGÓCIO:
    - Filtra apenas ORIGEM = 23 (receitas de amortização de empréstimos)
    ...
    # Filtra apenas origem de amortização de empréstimos (23) para 2025 e 2024
    df_2025 = df_processar[
        (df_processar['COEXERCICIO'] == 2025) & 
        (df_processar['ORIGEM'] == '23')
    ]
